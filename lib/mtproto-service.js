// Import localStorage polyfill FIRST (before MTProto)
...
class MTProtoService {
  constructor() {
    ...
    // Verify polyfill is working
    console.log('🔍 Checking localStorage:', typeof global.localStorage);
    console.log('🔍 Checking sessionStorage:', typeof global.sessionStorage);
